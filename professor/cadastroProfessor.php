...
<div class="branco">
    <div class="volta"></div>
    <a href="<?php if($acao == "editar") echo "principalProfessor.php?id=".$id; else echo "loginProfessor.php"; ?>" class="voltar"><img src="img\flecha.svg" alt="" srcset=""></a><br>
    <br><br>
    <div class="perfil"></div>  
        ...
        <input type="text" name="nome" placeholder="Nome" value="<?php if($acao == "editar") echo $vetor[0]["nome"]; ?>" class="input1"><br>
        <br>
        <input type="text" name="sobrenome" placeholder="Sobrenome"
        value="<?php if($acao == "editar") echo $vetor[0]["sobrenome"]; ?>"class="input2"><br>
        <br>
        <input type="text" name="areaAtuacao" placeholder="Área de atuação"
        value="<?php if($acao == "editar") echo $vetor[0]["areaAtuacao"]; ?>"class="input3"><br>
        <br>
        <input type="text" name="formacao" placeholder="Formação"
        value="<?php if($acao == "editar") echo $vetor[0]["formacao"]; ?>"class="input4"><br>
        <br>
        <input type="text" name="email" placeholder="E-mail" value="<?php if($acao == "editar") echo $vetor[0]["email"]; ?>"class="input5"><br>
        <br>
        <input type="password" name="senha" placeholder="Senha" value="<?php if($acao == "editar") echo $vetor[0]["senha"]; ?>"class="input6"><br>
        <br>
        <input type="password" name="confirmarSenha" placeholder="Confirme sua senha" class="input7"><br>
        <br>
